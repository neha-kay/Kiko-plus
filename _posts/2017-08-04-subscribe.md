...
<head>
        <title>Neha Kay's Blog</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
        <meta name="description" content="Neha Kay's Blog Email Forms">
        <meta name="keywords" content="Neha Kay's Blog">
...
.dijitTooltip{display:none !important;}
	...
	<body>
		...
		<div class="wrapper rounded6" id="templateContainer">
		    <h1 class="masthead"><img src="https://gallery.mailchimp.com/190027b3042ef1ffeac8ac1f8/images/510d1963-e5cf-4b2f-94c1-752a15f5f87c.jpg" alt="" border="0" style="border:0px  ; border-color:; border-style:; border-width: 0px; height: 720px; width: 900px; margin: 0; padding: 0;" width="900" height="720"></h1>
        ...
        <div id="subscribeFormWelcome"><span style="font-size:16px"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">If you liked the site or content, join the Kay Family!<br>
<br>
Add your email below -- I&#39;ll only email the most important content, at most 1/month :)</span></span>
</div>
<div class="indicates-required"><span class="asterisk">*</span> indicates required</div>



<form action="https://nehakay.us15.list-manage.com/subscribe/post" method="POST">
    <input type="hidden" name="u" value="190027b3042ef1ffeac8ac1f8">
    <input type="hidden" name="id" value="96664d6013">
    ...
    <div class="submit_container clear">
        <input type="submit" class="formEmailButton" name="submit" value="I'm in :)">
    </div>
    <input type="hidden" name="ht" value="d0667c9e3ce386b6899958d2db7e1645fcc13f59:MTUwODc2NjQ5Mi44NDIy">
